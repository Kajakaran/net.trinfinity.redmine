...
class CRM_Redmine_Utils {
  ...
  public static function createOptionGroup($params) {
    if (!isset($params['name']) || empty($params['name'])) {
      throw new Exception('Missing mandatory param name in CRM_Redmine_Utils::createOptionGroup');
    }
  ...
  public static function createGroup($params) {
    if (!isset($params['name']) || empty($params['name'])) {
      throw new Exception('Missing mandatory param name in CRM_Redmine_Utils::createGroup');
    }
  ...
  public static function createTag($params) {
    if (!isset($params['name']) || empty($params['name'])) {
      throw new Exception('Missing mandatory param name in CRM_Redmine_Utils::createTag');
    }
