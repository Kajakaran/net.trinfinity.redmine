 ...
 * Time: 17:01
 */
class CRM_Redmine_ProfileField
{
    protected $_apiParams = array();

    /**
     * CRM_Redmine_ProfileField constructor.
     *
    ...
    public function __construct($apiParams) {
        if (!isset($apiParams['field_name']) || empty($apiParams['field_name'])) {
            throw new Exception('Missing mandatory param name when constructing class CRM_Redmine_ProfileField');
        }
